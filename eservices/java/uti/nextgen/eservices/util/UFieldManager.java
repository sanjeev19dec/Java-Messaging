...
public class UFieldManager extends Object
{
  /**
   * Constructs a new manager with the given hash map.  The hash map contains 
   * field id's as keys and UField instances as values.
   *
   * @param  fieldMap  LinkedHashMap containing query fields.
   */

  public UFieldManager(LinkedHashMap fieldMap)
  {
    m_fieldMap = fieldMap;
  }
   ...
   * @param  id  Field id.
   *
   * @return  UField instance with the given field id.
   */

  public UField getField(String id)
  {
    return (UField)m_fieldMap.get(id);
  }
