...
/**
 * Function to perform "Cargo statement" queries.
 * <p>
...
public class CargoStatement extends BaseSQLFunction
{
  /**
   * Default constructor
   */

  public CargoStatement()
  {
  }
  ...
  //members
  private String m_where =  " where  UTIADM.DOC_LINE.DOC_LINE_TYPE = 'HB_GID'"+
  " and UTIADM.DOC_LINE.DOCUMENT_ID = UTIADM.DOC_HB.DOCUMENT_ID"+
  " and UTIADM.DOC_LINE.DOC_LINE_ID = UTIADM.DOC_LINE_GID.DOC_LINE_ID"+
  " and UTIADM.DOC_LINE.QTY_UNIT = 'PIECES'";
