...
/**
 * Function to perform " Handle Info Header statement" queries.
 * <p>
...
public class HandleInfoHeaderStatement extends BaseSQLFunction
{
  /**
   * Default constructor
   */

  public HandleInfoHeaderStatement()
  {
  }
  ...
  private void createFrom(StringBuffer query)
  {
    ...
    if (m_fieldManager.containsTable("DOC_INSTR_LINE"))
 ...
 private String m_where =
  " where UTIADM.DOC_INSTR_LINE.DOCUMENT_ID  = UTIADM.DOC_HB.DOCUMENT_ID "+
  " and UTIADM.DOC_INSTR_LINE.INSTR_TYPE = 'HANDLING' ";
